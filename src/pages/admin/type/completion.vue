    ...
    <n-form :model="model" label-placement="left">
        <n-space vertical>
            ...
            <n-form-item path="stem">
                <n-input v-model:value="model.stem" type="textarea" placeholder />
            </n-form-item>
            <n-form-item>
                <n-space vertical>
                    <n-space vertical>
                        <!-- {{ model.answer }} -->
                        <div v-for="item in model.answer" style="display: flex;">
                            <n-input
                                placeholder
                                v-model:value="item.label"
                                style="min-width:300px; width:fit-content;"
                            ></n-input>
                        </div>
                    </n-space>
                </n-space>
